...
// controller waali file me humare saare functions likhe hain , ki kab hume kya action lena hai 
const homeController = require('../controllers/home_controller');

console.log('router loaded');
//^ agar humare paas request '/' (root) ki aa rahi hai to controllers me jake home function ko chala do
